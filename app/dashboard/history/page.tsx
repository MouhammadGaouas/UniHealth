...
export default function PatientHistoryPage() {
            ...
            try {
                const url =
                    filter === "ALL"
                        ...
                        : `/api/appointments/history?status=${filter}`;
    ...
    return (
        <div className="min-h-screen bg-[#020617] pt-28 pb-16 px-4 md:px-8 font-sans selection:bg-blue-500/30 selection:text-blue-200">
            {/* Background accents */}
            <div className="fixed top-[-200px] right-[-200px] w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[150px] pointer-events-none" />
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 mt-2">
                                Review all your past appointments
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            {filtered.map((apt) => (
                                ...
                                >
                                    <div className="flex items-start gap-4">
                                        <div className="w-14 h-14 rounded-full bg-blue-900/20 flex items-center justify-center text-blue-400 border border-blue-900/30 flex-shrink-0">
                                            <FaUserMd size={26} />
                                        </div>
                                        <div>
                                            ...
                                            {apt.reason && (
                                                <p className="text-sm text-gray-500 mt-2">
                                                    <span className="font-semibold text-gray-400">Reason:</span> {apt.reason}
                                                </p>
                                            )}
                                        </div>
                                    </div>
